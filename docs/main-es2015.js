...
let AboutComponent = class AboutComponent {
    ...
    initSkills() {
        let list = [];
        _assets_Data_json__WEBPACK_IMPORTED_MODULE_2__.skills.sort().forEach(skill => {
...
/* harmony import */ var _project_details_project_details_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./project-details/project-details.component */ "./src/app/project-details/project-details.component.ts");
...
const routes = [
    ...
    { path: 'projects/project-details', component: _project_details_project_details_component__WEBPACK_IMPORTED_MODULE_8__["ProjectDetailsComponent"] },
...
let AppComponent = class AppComponent {
    constructor(router, projectService) {
        ...
        this.subscription = router.events.subscribe((event) => {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationStart"]) { // AFTER BROWSER REFRESH
...
/* harmony import */ var _project_details_project_details_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./project-details/project-details.component */ "./src/app/project-details/project-details.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _project_details_project_details_component__WEBPACK_IMPORTED_MODULE_10__["ProjectDetailsComponent"]
        ],
        imports: [
...
/* harmony import */ var _assets_Data_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/Data.json */ "./src/assets/Data.json");
var _assets_Data_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../assets/Data.json */ "./src/assets/Data.json", 1);
...
let ProjectService = class ProjectService {
    ...
    getSelectedProject() {
        if (this.selectedProject == undefined) {
            ...
            _assets_Data_json__WEBPACK_IMPORTED_MODULE_3__.projects.forEach(project => {
                if (project.id == id) {
                    this.selectedProject = project;
                }
            });
...
module.exports = __webpack_require__(/*! C:\Users\aryav\Desktop\Arya-Resume\src\main.ts */"./src/main.ts");
